...
function ContactInfo() {
  return (
    <Container className="p-4">
      ...
      <div className="grid grid-cols-12 mt-8 gap-8 md:gap-0 px-4">
        <div className="col-span-12 md:col-span-4">
          ...
          <div className="pt-4 font-sans">
            <p className="text-black text-sm">
              ...
              No.6B,Jalan SG 1/2,Seri Gombak,Batu Caves,68100 Selangor
              D.E,Malaysia.
            </p>
            <p className="text-black text-sm">
        ...
        <div className="col-span-12 md:col-span-8 px-0 md:px-12">
          <iframe
            // frameBorder="0"
            // scrolling="no"
            // marginHeight="0"
